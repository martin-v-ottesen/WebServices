 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.dtu.dk/", wsdlLocation = "http://Joshua:8080/Calculator/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.dtu.dk/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://Joshua:8080/Calculator/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.dtu.dk/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.dtu.dk/", "CalculatorPort"), Calculator.class, features);
    }
